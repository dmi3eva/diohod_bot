...
planet_button_04 = types.InlineKeyboardButton(text='\U0001F30F Планета 04', callback_data='planet_04')
planet_button_05 = types.InlineKeyboardButton(text='\U0001F30F Планета 05', callback_data='planet_05')
planet_button_06 = types.InlineKeyboardButton(text='\U0001F30E Планета 06', callback_data='planet_06')

planet_button_07 = types.InlineKeyboardButton(text='\U0001FA90 Планета 07', callback_data='planet_07')
planet_button_08 = types.InlineKeyboardButton(text='\U0001FA90 Планета 08', callback_data='planet_08')
planet_button_09 = types.InlineKeyboardButton(text='\U0001FA90 Планета 09', callback_data='planet_09')

planet_button_10 = types.InlineKeyboardButton(text='\U0001F30E Планета 10', callback_data='planet_10')
planet_button_11 = types.InlineKeyboardButton(text='\U0001F30E Планета 11', callback_data='planet_11')
planet_button_12 = types.InlineKeyboardButton(text='\U0001F30E Планета 12', callback_data='planet_12')
